...
table_extract <- function(filename){

  python_script <- "C:/Users/Nikzz/Downloads/hackfest/final.py"
  system(paste("py", python_script, filename))
  show_prompt("Conversion done!")
...
fluidRow(
 ...
 # Subtitle
           ...
           tags$hr(style = "border: 1px solid #FFFFFF; margin:80px 0 0 0;"),
    )
  ),
  fluidRow(
    column(3,
           actionButton("extract_inclusion_exclusion", "Extract Inclusion/Exclusion Data",style = "margin-top: 40px; margin-bottom: 20px; margin-left:120px"),
  div(),
           actionButton("extract_objectives_endpoints", "Extract Objectives and Endpoints",style = "margin-bottom: 20px;margin-left:120px"),
  div(),
           actionButton("clear_data", "Clear Data",style = "margin-bottom: 20px;margin-left:190px"),
  div(),
           actionButton("exit", "Exit",style = "margin-bottom: 20px;margin-left:210px")
    ),
 column(1,
...
div(style="margin-top: 20px;",
                 ...
                 numericInput("block_input",  label = tags$span(style = "color: #FFFFFF;",  "Block Number"), value = 1, min = 1),
...
div(style="margin-top: 20px;",
     ...
     numericInput("block_input2",  label = tags$span(style = "color: #FFFFFF;",  "Block Number"), value = 1, min = 1),
...
server <- function(input, output, session) {
  ...
  observeEvent(input$submit_objectives_endpoints, {
    tryCatch({ 
            main(2, input$file_input2$name, 1, input$block_input2)
           },
           error = function(e) {
